...
{
    public class NutritionPlanRepository : EFRepository<NutritionPlan>, INutritionPlanRepository
    {
        public NutritionPlanRepository(SportContext context) : base(context)
        {
        }
    }
}
